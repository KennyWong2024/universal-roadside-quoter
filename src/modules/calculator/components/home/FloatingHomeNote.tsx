...
interface FloatingHomeNoteProps {
    generateNote: () => string;
    totalAmount: number;
}

export const FloatingHomeNote = ({ generateNote, totalAmount }: FloatingHomeNoteProps) => {
            ...
            <button
                ...
                className={`w-full py-5 px-6 rounded-2xl font-extrabold text-lg shadow-lg transition-all flex items-center justify-center gap-3
                    ${copied
                        ...
                        : 'bg-emerald-600 hover:bg-emerald-700 text-white hover:shadow-xl hover:-translate-y-1 active:scale-95'}`}
            >
                {copied ? (
